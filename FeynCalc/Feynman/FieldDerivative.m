...
FieldDerivative /:
MakeBoxes[FieldDerivative[a_, _, lis__LorentzIndex],
TraditionalForm] :=
RowBox[{SubscriptBox[
...
FieldDerivative /:
MakeBoxes[FieldDerivative[a_, lis__LorentzIndex],
TraditionalForm] :=
RowBox[{SubscriptBox[
MakeBoxes[ StyleForm["\[PartialD]", FontSlant -> "Italic"]],
	RowBox[MakeBoxes[TraditionalForm[#]] & /@ {lis}]], "(",
...
FieldDerivative /:
MakeBoxes[FieldDerivative[a_, _, lis__FCPartialD],
TraditionalForm] :=
RowBox[{SubscriptBox[
MakeBoxes[ StyleForm["\[PartialD]", FontSlant -> "Italic"]],
	RowBox[MakeBoxes[TraditionalForm[#]] & /@ {lis}]], "(",
...
FieldDerivative /:
MakeBoxes[FieldDerivative[a_, lis___FCPartialD],
TraditionalForm] :=
RowBox[{SubscriptBox[
MakeBoxes[StyleForm["\[PartialD]", FontSlant -> "Italic"]],
RowBox[MakeBoxes[TraditionalForm[#]] & /@ {lis}]], "(",
