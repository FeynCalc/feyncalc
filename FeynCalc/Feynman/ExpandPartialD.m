...
epskill[prod_Times] :=
	...
	mydot[pa1___, QuantumField[___FCPartialD,
			FCPartialD[LorentzIndex[mu_,___]],
			___FCPartialD,
			fieldname_, LorentzIndex[_,___],
			SUNIndex[s1_]
			],
	pa2___,
	QuantumField[___FCPartialD,
			FCPartialD[LorentzIndex[nu_,___]],
			___FCPartialD,
			fieldname_, LorentzIndex[_,___],
			SUNIndex[s2_]
			],
	...
	) * QuantumField[p1___FCPartialD, FCPartialD[LorentzIndex[mu_,di___]],
	p2___FCPartialD,
	name_ /; (Head[name] =!= FCPartialD) &&
				(Head[name] =!= LorentzIndex),
	...
	p1,FCPartialD[LorentzIndex[nu,de]], p2, name,
	...
	QuantumField[p1___FCPartialD,
		FCPartialD[LorentzIndex[mu_,de___]],
		p2___FCPartialD,
		name_ /; (Head[name] =!= FCPartialD) &&
					(Head[name] =!= LorentzIndex),
	...
	QuantumField[p1,FCPartialD[LorentzIndex[nu, di]], p2, name,
...
qf2[a___, b_, n_, c___] :=
	qf2[a, n, b, c] /;
	(!NonCommFreeQ[n]) &&
	FreeQ2[n, {Pattern, FCPartialD, LeftPartialD, RightPartialD,
	QuantumField, Blank, qf1, qf2} ] &&
	((Head[b] === FCPartialD) || (Head[b] === QuantumField) ||
	(Head[b] === LeftPartialD) || (Head[b] === RightPartialD));

qf3[f1_qf3] :=
	f1;
qf3[a___, FCPartialD[Momentum[OPEDelta]^m_],
			FCPartialD[Momentum[OPEDelta]^n_], b___
	] :=
...
qf5[a___, QuantumField[f1__], LeftPartialD[mu_], b___] :=
	(qf5st[a, quanf[FCPartialD[mu], f1], b] /. quanf -> QuantumField /.
		qf5st -> qf5) /; FreeQ2[{a}, {FCPartialD, QuantumField, LeftPartialD,
									RightPartialD}];
...
qf5st[a___, FCPartialD[Momentum[OPEDelta]^m_],
			FCPartialD[Momentum[OPEDelta]^n_], b___
	] :=
...
qf5[c_/;Head[c] =!= LeftPartialD, b___, QuantumField[f1__],
	...
	OPESum[Binomial[m, opk] *
		qf5st[c, b,
					...
					quanf[FCPartialD[Momentum[OPEDelta]^opk], f1],
				a
				],
		{opk, 0, m}
		]
...
qf5[a___,RightPartialD[Momentum[OPEDelta]^m_],
		QuantumField[f1__], b___,c_/;FreeQ[{FCPartialD,RightPartialD},Head[c]]
	] :=
	( (opk = OPEk[$OPEKCOUNT++];
	OPESum[Binomial[m, opk] *
		qf5st[a, quanf[FCPartialD[Momentum[OPEDelta]^opk], f1],
...
quanf[f1___, FCPartialD[Momentum[OPEDelta]^m_],
			FCPartialD[Momentum[OPEDelta]],
		f2___
	] :=
...
quanf[f1___, FCPartialD[Momentum[OPEDelta]],
			FCPartialD[Momentum[OPEDelta]^m_],
		f2___
	] :=
	quanf[f1, FCPartialD[Momentum[OPEDelta]^(m+1)], f2];
...
quanf[f1___, FCPartialD[Momentum[OPEDelta]^m_],
			FCPartialD[Momentum[OPEDelta]^n_],
		f2___
	] :=
...
quanf[par1_FCPartialD, parr__FCPartialD,
		fname_/;Head[fname]=!=FCPartialD, rest___] :=
