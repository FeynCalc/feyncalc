...
diagsPairAnnihilation =
  InsertFields[topPairAnnihilation, {F[2, {1}],-F[2, {1}]} -> {V[1], V[1]}, InsertionLevel -> {Classes},
...
ampPairAnnihilation =
 Map[ReplaceAll[#, FeynAmp[_, _, amp_, ___] :> amp] &,
   Apply[List,
    FCPrepareFAAmp[CreateFeynAmp[diagsPairAnnihilation,
...
sqAmpPairAnnihilationPeskin=(2EL^4(ScalarProduct[p1,k2]/ScalarProduct[p1,k1]+ScalarProduct[p1,k1]/ScalarProduct[p1,k2]+
