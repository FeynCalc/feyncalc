...
$$\text{FCLoopFindMomentumShifts: }\;\text{Failed to derive the momentum shifts between topologies topo2 and topo1. Possibly due to no valid shifts, nonquadratic propagators, or required external momentum shifts.}$$
