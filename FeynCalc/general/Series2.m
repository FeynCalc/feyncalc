...
BeginPackage["HighEnergyPhysics`general`Series2`",{"HighEnergyPhysics`FeynCalc`"}];
...
Series2[exp_, a_List, b__List] := Series2[Normal[Series2[exp, a]], b];

Series2[a_, {x_, 0, nn_}, ops___Rule] := Block[
{re, rec, polysub, polysimp, finsub, res, n=nn, ll,
 hypfix, hyp, hyb, hyphyp, gamspec},

$localprint = Print /. {ops} /. Options[Series2];

gammas[y_] := If[FreeQ[y, Gamma], y,
...
F21CHECK := Unique[F21CHECKIT];

com[z_] := If[$localprint === True,
Print["using the F21 expansion ", ToString[z]]
             ];
...
End[]; EndPackage[];
(* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ *)
If[$VeryVerbose > 0,WriteString["stdout", "Series2 | \n "]];
Null
