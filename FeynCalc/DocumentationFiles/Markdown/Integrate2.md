...
$$\left\{0.059873,\zeta (3)-\frac{3}{2} \zeta (2) \log (2)\right\}$$
...
$$\frac{2 i \pi  \text{Li}_2(-z)}{1-z}+\frac{4 \text{Li}_3(1-z)}{1-z}+\frac{2 \text{Li}_3(-z)}{1-z}+\frac{4 \text{Li}_3\left(\frac{1}{z+1}\right)}{1-z}+\frac{4 \text{Li}_3\left(-\frac{1-z}{z+1}\right)}{1-z}-\frac{4 \text{Li}_3\left(\frac{1-z}{z+1}\right)}{1-z}-\frac{2 \text{Li}_2(1-z) \log (z)}{1-z}-\frac{2 \text{Li}_2(-z) \log (z)}{1-z}+\frac{4 \text{Li}_2(-z) \log (1-z)}{1-z}-\frac{2 S_{12}(1-z)}{1-z}+\frac{i \pi  \zeta (2)}{1-z}-\frac{\zeta (2) \log (z)}{1-z}+\frac{2 \zeta (2) \log (1-z)}{1-z}+\frac{2 \zeta (2) \log (z+1)}{1-z}-\frac{2 \zeta (3)}{1-z}+\frac{\log ^3(z)}{6 (1-z)}-\frac{2 \log ^3(z+1)}{3 (1-z)}-\frac{\log (1-z) \log ^2(z)}{1-z}-\frac{\log (z+1) \log ^2(z)}{1-z}-\frac{i \pi  \log ^2(z)}{2 (1-z)}+\frac{4 \log (1-z) \log (z+1) \log (z)}{1-z}+\frac{2 i \pi  \log (z+1) \log (z)}{1-z}$$
