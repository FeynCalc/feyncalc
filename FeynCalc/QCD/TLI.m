...
v: k1.k1, w: k2.k2,  x: p.k1, y: p.k2, z: k1.k2, a: dl.k1, b: dl.k2,  c:
dl.(p-k1), d: dl.(p-k2), e: dl.(k1-k2)

TLI[{mu1, ...}, {nu1, ...}][{v,w,x,y,z},{a,b,c,d,e}, {al,be,ga,de,ep}] is a
tensor integral, where mu1 belongs to k1 and nu1 to k2.

TLI[any___,{a,b,c,d,e,0,0}, {al,be,ga,de,ep}] simplifies to TLI[any,
...
Options[TLI] =  {EpsilonOrder -> 0, Momentum -> FCGV["p"]};



TLI[a__, pr_ /; !FreeQ[pr, {_,0}], ___Rule] :=
	TLI[a, pr /. {b_,0} :> b];
...
TLI[{1,0,0,0,0}, {a__},{0,b__}, opt___Rule] :=
	TLI[{a},{-1,b},opt];
TLI[{2,0,0,0,0}, {a__},{0,b__}, opt___Rule] :=
	TLI[{a},{-2,b},opt];

TLI[{0,1,0,0,0}, {a__},{b_,0,c__}, opt___Rule] :=
	TLI[{a},{b,-1,c},opt];
TLI[{0,2,0,0,0}, {a__},{b_,0,c__}, opt___Rule] :=
	TLI[{a},{b,-2,c},opt];
...
TLI[{a_Integer,b_ /; Head[b]=!=Integer,c_,d_,e_},
		...
		opt___] :=
	(-1)^e TLI[{b,a,d,c,e},{be,al,0,ga,ep},opt];
...
TLI[{0,0,0,0,0},{x__},{y__}, opt___Rule] :=
	TLI[{x}, {y}, opt];
TLI[{x1_,x2_,x3_,x4_,x5_, 0, 0}, {y__}] :=
	TLI[{x1,x2,x3,x4,x5},{y}];
