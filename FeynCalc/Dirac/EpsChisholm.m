	...
	Block[ {new = 0, xx,i},
		...
		If[ Head[xx]===Plus,
			For[i = 1, i<=Length[xx], i++,
				...
				eepsrule/. epsspcrule0/.epsspcrule0/.
				epsspcrule/.epsspcrule)
			],
			new = (xx/.Eps->eeps)/.eepsrule/.
			eepsrule/.eepsrule/.eepsrule/. eepsrule;
...
eepsrule = {
	m_. DOT[ x___,DiracGamma[LorentzIndex[in_]],y___] eeps[a___,LorentzIndex[in_],b_,c___] :>
		-m DOT[x,DiracGamma[LorentzIndex[in]],y] eeps[a,b,LorentzIndex[in],c]
};

epsspcrule0 = {
	m_. DOT[ x___,DiracGamma[LorentzIndex[in_]],y___] eeps[a_,b_,c_,LorentzIndex[in_]] :>
		((- I m ( DOT[x,DiracGamma[a],DiracGamma[b],DiracGamma[c], DiracGamma[5],y] -
		scev[a,b] DOT[x,DiracGamma[c].DiracGamma[5],y] -
		scev[b,c] DOT[x,DiracGamma[a].DiracGamma[5],y] +
		scev[a,c] DOT[x,DiracGamma[b].DiracGamma[5],y])//SpinorChainEvaluate)//Expand)/;
...
epsspcrule = {
	...
	(- I ( DOT[x,DiracGamma[a],DiracGamma[b],DiracGamma[c],    DiracGamma[5],y] -
	scev[a,b] DOT[x,DiracGamma[c].DiracGamma[5],y] - scev[b,c] DOT[x,DiracGamma[a].DiracGamma[5],y] +
	scev[a,c] DOT[x,DiracGamma[b].DiracGamma[5],y])//SpinorChainEvaluate)//Expand
};
