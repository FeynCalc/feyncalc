...
(* :Title: EWUpQuarkDownAntiquarkToPositronElectronNeutrinoTree                                                  *)
...
(* :Summary:  Computation of the matrix element squared for an up quark
			  and an antidown quark annihilating into a positron and an 
			  electron neutrino in Electroweak Theory at tree level. *)
...
If[ $FrontEnd === Null,
		...
		Print["Computation of the matrix element squared for an up quark
			  and an antidown quark annihilating into a positron and an 
			  electron neutrino in Electroweak Theory at tree level."];
];
...
IncomingMomenta->{p1,p2},OutgoingMomenta->{k1,k2},DropSumOver->True]//Contract
...
ampSquaredKnown=(t^2*SMP["e"]^4*SMP["V_ud", -I]*SMP["V_ud", I])/(12*(s - SMP["m_W"]^2)^2*SMP["sin_W"]^4);
