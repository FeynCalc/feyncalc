...
(* :Title: AsymptoticExpansion-tad2LxFx111x120xxEp999x					*)
...
(* :Summary: Asymptotic expansion of a 2L tadpole integral 
			tad2LxFx111x120xxEp999x in m2^2/m1^2.                            *)
...
If[ $FrontEnd === Null,
		...
		Print["Asymptotic expansion of a 2L tadpole integral tad2LxFx111x120xxEp999x in m2^2/m1^2."];
];
...
{int,topo}={GLI[tad2LxFx111x120xxEp999x,{1,1,1}],FCTopology[tad2LxFx111x120xxEp999x,{FAD[{k1,m1}],FAD[{k2,m2}],FAD[{k1-k2,0}]},{k1,k2},{},{},{}]}
id=topo[[1]]
...
newId=newId=ToExpression[StringReplace[ToString[id],{"F"->"Am2m1o4","Ep999"->"Ep1"}]]
...
(*v1=(0.5*(49. + 1.*m2^2))/ep^2 - (2.*(58.5995973 - 0.75*m2^2 + 1.*m2^2*Log[m2]))/ep - 0.02040816*(-22661.13488575158 + 479.58365428338465*m2^2 - 2.6959128113460493*m2^4 - 185.39841906374704*m2^2*Log[m2] + 1.*m2^4*Log[m2] - 
   98.0000156800025*m2^2*Log[m2]^2) + 0.02040816*ep*(-64845.12347805976 + 1941.2354920776786*m2^2 - 12.352598176415706*m2^4 - 434.57382635181216*m2^2*Log[m2] + 1.3918207226913155*m2^4*Log[m2] - 185.39841906374704*m2^2*Log[m2]^2 + 
   1.*m2^4*Log[m2]^2 - 65.33334362333498*m2^2*Log[m2]^3)*)
