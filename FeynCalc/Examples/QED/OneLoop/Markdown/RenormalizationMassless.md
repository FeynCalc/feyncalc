...
$$\{\text{/tmp/Reduction-leptonSE\$Amp-1L-massless/leptonSEtopo1/job.yaml}\}$$
...
$$\{\text{/tmp/Reduction-leptonSE\$Amp-1L-massless/leptonSEtopo1/KiraLoopIntegrals}\}$$

$$\left(
\begin{array}{cc}
 \;\text{/tmp/Reduction-leptonSE\$Amp-1L-massless/leptonSEtopo1/config/integralfamilies.yaml} & \;\text{/tmp/Reduction-leptonSE\$Amp-1L-massless/leptonSEtopo1/config/kinematics.yaml} \\
\end{array}
\right)$$
...
$$\frac{i \;\text{a4} \xi _{V(1)} \gamma \cdot p}{\text{ep}}$$
...
$$\left\{\text{rc}(\text{delZpsi},1)\to -\frac{\xi _{V(1)}}{\text{ep}}\right\}$$
...
$$\{\text{/tmp/Reduction-photonSE\$Amp-1L-massless/photonSEtopo1/job.yaml}\}$$
...
$$\{\text{/tmp/Reduction-photonSE\$Amp-1L-massless/photonSEtopo1/KiraLoopIntegrals}\}$$

$$\left(
\begin{array}{cc}
 \;\text{/tmp/Reduction-photonSE\$Amp-1L-massless/photonSEtopo1/config/integralfamilies.yaml} & \;\text{/tmp/Reduction-photonSE\$Amp-1L-massless/photonSEtopo1/config/kinematics.yaml} \\
\end{array}
\right)$$
...
$$\left(
\begin{array}{c}
 G^{\text{photonSEtopo1}}(1)\to G^{\text{tad1Lv2}}(1) \\
 G^{\text{tad1Lv2}}(1) \\
\end{array}
\right)$$
...
$$\frac{4 i \;\text{a4} N_f \left(3 \;\text{mxt}^2 g^{\mu \nu }-\text{pp} g^{\mu \nu }+p^{\mu } p^{\nu }\right)}{3 \;\text{ep}}$$
...
$$\left\{\text{rc}(\text{delZA},1)\to -\frac{4 N_f}{3 \;\text{ep}},\text{rc}(\text{delZAmxt},1)\to -\frac{2 N_f}{\text{ep}},\text{rc}(\text{delZxi},1)\to -\frac{4 N_f}{3 \;\text{ep}}\right\}$$
...
$$\{\text{/tmp/Reduction-leptonPhotonVTX\$Amp-1L-massless/leptonPhotonVTXtopo1/job.yaml}\}$$
...
$$\{\text{/tmp/Reduction-leptonPhotonVTX\$Amp-1L-massless/leptonPhotonVTXtopo1/KiraLoopIntegrals}\}$$

$$\left(
\begin{array}{cc}
 \;\text{/tmp/Reduction-leptonPhotonVTX\$Amp-1L-massless/leptonPhotonVTXtopo1/config/integralfamilies.yaml} & \;\text{/tmp/Reduction-leptonPhotonVTX\$Amp-1L-massless/leptonPhotonVTXtopo1/config/kinematics.yaml} \\
\end{array}
\right)$$
...
$$\left(
\begin{array}{c}
 G^{\text{leptonPhotonVTXtopo1}}(1)\to G^{\text{tad1Lv2}}(1) \\
 G^{\text{tad1Lv2}}(1) \\
\end{array}
\right)$$
...
$$\left\{\text{Zpsi}\to 1-\frac{\text{a4} \xi _{V(1)}}{\text{ep}},\text{ZA}\to 1-\frac{4 \;\text{a4} N_f}{3 \;\text{ep}},\text{ZAmxt}\to 1-\frac{2 \;\text{a4} N_f}{\text{ep}},\text{Ze}\to \frac{2 \;\text{a4} N_f}{3 \;\text{ep}}+1,\text{Zxi}\to 1-\frac{4 \;\text{a4} N_f}{3 \;\text{ep}}\right\}$$
...
$$\text{$\backslash $tCPU Time used: }36.531\text{ s.}$$