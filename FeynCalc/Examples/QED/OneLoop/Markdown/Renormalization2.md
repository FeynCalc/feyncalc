...
$$\left\{-4 \pi  \alpha  \left(\frac{\gamma ^{\mu }.\left(m_e+\gamma \cdot l\right).\gamma ^{\mu }}{\left(l^2-m_e^2\right).(l-p)^2}-\frac{\xi  (-(\gamma \cdot (l-p))).\left(m_e+\gamma \cdot l\right).(\gamma \cdot (l-p))}{\left(l^2-m_e^2\right).(l-p)^4}+\frac{(-(\gamma \cdot (l-p))).\left(m_e+\gamma \cdot l\right).(\gamma \cdot (l-p))}{\left(l^2-m_e^2\right).(l-p)^4}\right),i \left(Z_{\psi }-1\right) \gamma \cdot p-i m_e \left(Z_m Z_{\psi }-1\right)\right\}$$
...
$$\left\{-\frac{4 \pi  \alpha  \;\text{tr}\left(\left(m_e-\gamma \cdot l\right).\gamma ^{\nu }.\left(m_e-\gamma \cdot (l-p)\right).\gamma ^{\mu }\right)}{\left(l^2-m_e^2\right).\left((l-p)^2-m_e^2\right)},-\frac{i \left(\xi  p^2 Z_A Z_{\xi } g^{\mu \nu }-\xi  Z_A p^{\mu } p^{\nu } Z_{\xi }+Z_A p^{\mu } p^{\nu }-\xi  p^2 Z_{\xi } g^{\mu \nu }+\xi  p^{\mu } p^{\nu } Z_{\xi }-p^{\mu } p^{\nu } Z_{\xi }\right)}{\xi  Z_{\xi }}\right\}$$
...
$$\left\{-4 \pi  \alpha  \;\text{e} \left(\frac{\gamma ^{\text{Lor3}}.\left(m_e+\gamma \cdot (k+l)\right).\gamma ^{\mu }.\left(m_e+\gamma \cdot l\right).\gamma ^{\text{Lor3}}}{\left(l^2-m_e^2\right).\left((k+l)^2-m_e^2\right).(k+l-\text{p2})^2}-\frac{\xi  (-(\gamma \cdot (k+l-\text{p2}))).\left(m_e+\gamma \cdot (k+l)\right).\gamma ^{\mu }.\left(m_e+\gamma \cdot l\right).(\gamma \cdot (k+l-\text{p2}))}{\left(l^2-m_e^2\right).\left((k+l)^2-m_e^2\right).(k+l-\text{p2})^4}+\frac{(-(\gamma \cdot (k+l-\text{p2}))).\left(m_e+\gamma \cdot (k+l)\right).\gamma ^{\mu }.\left(m_e+\gamma \cdot l\right).(\gamma \cdot (k+l-\text{p2}))}{\left(l^2-m_e^2\right).\left((k+l)^2-m_e^2\right).(k+l-\text{p2})^4}\right),i \;\text{e} \gamma ^{\mu } \left(1-\sqrt{Z_A} Z_e Z_{\psi }\right)\right\}$$
...
$$\left\{-4 \pi  \alpha  \left(\frac{\gamma ^{\mu }.\left(m_e+\gamma \cdot l\right).\gamma ^{\mu }}{\left(l^2-m_e^2\right).(l-p)^2}-\frac{\xi  (-(\gamma \cdot (l-p))).\left(m_e+\gamma \cdot l\right).(\gamma \cdot (l-p))}{\left(l^2-m_e^2\right).(l-p)^4}+\frac{(-(\gamma \cdot (l-p))).\left(m_e+\gamma \cdot l\right).(\gamma \cdot (l-p))}{\left(l^2-m_e^2\right).(l-p)^4}\right),i \delta _{\psi } \gamma \cdot p-i m_e \left(\delta _{\psi }+\delta _m\right)\right\}$$
...
$$\left\{-\frac{4 \pi  \alpha  \;\text{tr}\left(\left(m_e-\gamma \cdot l\right).\gamma ^{\nu }.\left(m_e-\gamma \cdot (l-p)\right).\gamma ^{\mu }\right)}{\left(l^2-m_e^2\right).\left((l-p)^2-m_e^2\right)},i \delta _A \left(p^{\mu } p^{\nu }-p^2 g^{\mu \nu }\right)\right\}$$
...
$$\left\{-4 \pi  \alpha  \;\text{e} \left(\frac{\gamma ^{\text{Lor3}}.\left(m_e+\gamma \cdot (k+l)\right).\gamma ^{\mu }.\left(m_e+\gamma \cdot l\right).\gamma ^{\text{Lor3}}}{\left(l^2-m_e^2\right).\left((k+l)^2-m_e^2\right).(k+l-\text{p2})^2}-\frac{\xi  (-(\gamma \cdot (k+l-\text{p2}))).\left(m_e+\gamma \cdot (k+l)\right).\gamma ^{\mu }.\left(m_e+\gamma \cdot l\right).(\gamma \cdot (k+l-\text{p2}))}{\left(l^2-m_e^2\right).\left((k+l)^2-m_e^2\right).(k+l-\text{p2})^4}+\frac{(-(\gamma \cdot (k+l-\text{p2}))).\left(m_e+\gamma \cdot (k+l)\right).\gamma ^{\mu }.\left(m_e+\gamma \cdot l\right).(\gamma \cdot (k+l-\text{p2}))}{\left(l^2-m_e^2\right).\left((k+l)^2-m_e^2\right).(k+l-\text{p2})^4}\right),-\frac{1}{2} i \;\text{e} \gamma ^{\mu } \left(\delta _A+2 \delta _{\psi }+2 \delta _e\right)\right\}$$
...
$$\text{$\backslash $tCPU Time used: }43.514\text{ s.}$$