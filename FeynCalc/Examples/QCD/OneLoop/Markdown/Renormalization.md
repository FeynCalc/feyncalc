...
$$-\frac{i \delta _{\text{Col1}\;\text{Col2}} \left(m_q \left(C_F (\Delta +\gamma +\log (\pi )) \left(\xi _{\text{G}}+3\right) g_s^2+16 \pi ^2 \left(Z_m Z_{\psi }-1\right)\right)-\gamma \cdot p \left(C_F (\Delta +\gamma +\log (\pi )) \xi _{\text{G}} g_s^2+16 \pi ^2 \left(Z_{\psi }-1\right)\right)\right)}{16 \pi ^2}$$
...
$$-\frac{i \Delta  C_F \left(\xi _{\text{G}}+3\right) g_s^2 m_q \delta _{\text{Col1}\;\text{Col2}}}{16 \pi ^2}+\frac{i \Delta  C_F \xi _{\text{G}} g_s^2 \delta _{\text{Col1}\;\text{Col2}} \gamma \cdot p}{16 \pi ^2}-i \delta _{\psi } m_q \delta _{\text{Col1}\;\text{Col2}}-i \delta _m m_q \delta _{\text{Col1}\;\text{Col2}}+i \delta _{\psi } \delta _{\text{Col1}\;\text{Col2}} \gamma \cdot p$$
...
$$\text{$\backslash $tCPU Time used: }28.93\text{ s.}$$