...
(* :Title: Renormalization-QQbar-Massless										*)
...
(* :Summary:  Renormalization, QCD, MSbar, Quark self-energy, massless, 2-loop *)
...
Collect2[#,mxt,IsolateNames->KK]&//Series[#,{mxt,0,0}]&//Normal//FRH//ReplaceAll[#,Log[m_^2]:>2Log[m]]&//Collect2[#,ep,mxt]&
