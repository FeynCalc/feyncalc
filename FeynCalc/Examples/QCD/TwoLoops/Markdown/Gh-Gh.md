...
![1sih58kj8jn4p](img/1sih58kj8jn4p.svg)

![0azm2cxgztk7a](img/0azm2cxgztk7a.svg)

![08rh2vkhly6wl](img/08rh2vkhly6wl.svg)
...
$$\text{FIRECreateIntegralFile: }\;\text{fctopology1}\;\text{, number of loop integrals: }242$$
...
$$\text{$\backslash $tCPU Time used: }57.593\text{ s.}$$