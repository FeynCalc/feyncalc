...
OutgoingMomenta->{kG,p2},UndoChiralSplittings->True,TransversePolarizationVectors->{kG},DropSumOver->True,List->False,SMP->True]//Contract
...
SetMandelstam[s, t, u, p1,kGamma, -kG,-p2, SMP["m_u"], qQ,0,SMP["m_u"]];
...
ampQiGammaStarToQiG3=ampQiGammaStarToQiG2*(ComplexConjugate[ampQiGammaStarToQiG2])//
...
ampQiGammaStarToQiG4=(ampQiGammaStarToQiG3/.{SMP["m_u"]->0,SUNN->3})//Simplify


masslessAmpQiGammaStarToQiG=(TrickMandelstam[ampQiGammaStarToQiG4,{s,t,u,qQ^2}]/.u->qQ^2-s-t/.qQ->I Q)//Simplify


masslessAmpQiGammaStarToQiGField= (16/3) SMP["e"]^2 EQ^2 SMP["g_s"]^2 (-t/s-s/t - 2 Q^2(s+t+Q^2)/(t s));
