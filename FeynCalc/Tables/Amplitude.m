...
abbs = {
					alpha :> FCGV["\[Alpha]"], beta :> FCGV["\[Beta]"],
					al    :> FCGV["\[Alpha]"], be   :> FCGV["\[Beta]"],
					delta :> FCGV["\[Delta]"],
					kappa :> FCGV["\[Kappa]"],
					ka    :> FCGV["\[Kappa]"],
					gamma :> FCGV["\[Gamma]"],
					mu :> FCGV["\[Mu]"], nu :> FCGV["\[Nu]"],
					rho:> FCGV["\[Rho]"], sigma:> FCGV["\[Sigma]"],
					ro:> FCGV["\[Rho]"], si:> FCGV["\[Sigma]"],
					lambda:> FCGV["\[Lambda]"], tau:> FCGV["\[Tau]"],
					xi :> FCGV["\[Xi]"],
					a :> FCGV["a"], b :> FCGV["b"], c :> FCGV["c"],
					d :> FCGV["d"], e :> FCGV["e"], f :> FCGV["f"],
					i :> FCGV["i"], j :> FCGV["j"], h :> FCGV["h"],
					r :> FCGV["r"],
					s :> FCGV["s"], v :> FCGV["v"], w :> FCGV["w"]
			};
