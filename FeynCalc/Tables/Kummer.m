...
Which[i === 1,  u /. F[a_,b_,c_,z_] :>
			...
			i === 9,  u /. F[a_,bb_,cc_,zz_] :>  (* z = 1/zz *)
									Factor2[-1/zz]^(a+bb-cc) Factor2[1-1/zz]^(-a-bb+cc) *
											F[-a + cc, -bb + cc, cc, Factor2[zz]]
							,
			...
			i === 11, u /. F[a_,bb_,cc_,zz_] :>  (* z = 1/zz *)
									Factor2[-1/zz]^a (Factor2[1-zz])^(-a) *
										F[a, -bb + cc, cc, Factor2[1/(1-1/zz)]]
							,
			i === 12, u /. F[a_,bb_,cc_,zz_] :> (* z = 1/zz *)
									Factor2[-1/zz]^(bb-a) Factor2[1-1/zz]^(-bb) *
										F[bb, -a + cc, cc, Factor2[1/(1-1/zz)]]
							,
			i === 13, u /. F[aa_,b_,cc_,zz_] :> (* z = 1/zz *)
									Factor2[-1/zz]^(aa + b - cc) Factor2[1-1/zz]^(-aa - b + cc)*
									F[-b + cc, -aa + cc, cc, Factor2[zz]]
							,
			...
			i === 15, u /. F[aa_,b_,cc_,zz_] :> (* z = 1/zz *)
									Factor2[-1/zz]^b Factor2[1-1/zz]^(-b) *
									F[b,-aa + cc,cc,Factor2[1/(1-1/zz)]]
							,
			i === 16, u /. F[aa_,b_,cc_,zz_] :> (* z = 1/zz *)
									Factor2[-1/zz]^aa Factor2[1-1/zz]^(-aa) *
									F[aa,cc-b,cc,Factor2[1/(1-1/zz)]]
							,
			...
			i === 94, u /. F[a_,b_,g_,z_] :>
									gm[g] gm[g-a-b]/gm[g-a]/gm[g-b] *
										F[a,b,a+b-g+1,Factor2[1-z]] +
									Factor2[1-z]^(g-a-b) gm[g] gm[a+b-g]/gm[a]/gm[b]*
										F[g-a,g-b,g-a-b+1,Factor2[1-z]]
							,
			i === 95, u /. F[a_,b_,g_,z_] :>
									Factor2[1-z]^(-a) gm[g] gm[b-a]/gm[b]/gm[g-a] *
										F[a,g-b,a-b+1,Factor2[1/(1-z)]] +
									Factor2[1-z]^(-b) gm[g] gm[a-b]/gm[a]/gm[g-b] *
										F[b,g-a,b-a+1,Factor2[1/(1-z)]]
							,
			i === 96, u /. F[a_,b_,g_,z_] :>
									gm[g] gm[b-a]/gm[b]/gm[g-a] PowerSimplify[(-1)^a] *
										Factor2[z]^(-a) F[a,a+1-g,a+1-b, Factor2[1/z]] +
									gm[g] gm[a-b]/gm[a]/gm[g-b] PowerSimplify[(-1)^b] *
										Factor2[z]^(-b) F[b,b+1-g,b+1-a, Factor2[1/z]]
