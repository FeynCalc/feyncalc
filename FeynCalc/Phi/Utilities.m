...
Options[UReduce] = {SMMToMM -> False, FullReduce -> True, SUNN -> 2, UDimension -> Automatic};
Options[SMMToMM] = {SUNN -> 2};
Options[UPerturb] = {ExpansionOrder -> {1}, SUNN -> 2,
...
Options[CayleyHamiltonRules] = {SUNN -> 2, UDimension -> 2,
...
Options[CayleyHamiltonTrick] = {SUNN -> 2, UDimension -> 2,
...
sturules[opts___] /; ((MomentaSumLeft /. Flatten[{opts}] /.
							Options[MandelstamReduce]) === All) :=
	{Pair[
	Momentum[mv[opts][1], ___], Momentum[mv[opts][2], ___]] ->
	MandelstamS/
	2 - (Pair[Momentum[mv[opts][1]], Momentum[mv[opts][1]]] +
	Pair[Momentum[mv[opts][2]], Momentum[mv[opts][2]]])/2,
	Pair[Momentum[mv[opts][2], ___], Momentum[mv[opts][3], ___]] ->
	MandelstamT/
	2 - (Pair[Momentum[mv[opts][2]], Momentum[mv[opts][2]]] +
...
sturules[opts___] /; (MomentaSumLeft /. Flatten[{opts}] /.
				...
				Phi`Objects`FirstHalf :=
	{Pair[
	Momentum[mv[opts][1], ___], Momentum[mv[opts][2], ___]] ->
	MandelstamS/
	2 - (Pair[Momentum[mv[opts][1]], Momentum[mv[opts][1]]] +
	Pair[Momentum[mv[opts][2]], Momentum[mv[opts][2]]])/2,
	Pair[Momentum[mv[opts][2], ___],
	Momentum[mv[opts][3], ___]] -> -MandelstamT/
	2 + (Pair[Momentum[mv[opts][2]], Momentum[mv[opts][2]]] +
	Pair[Momentum[mv[opts][3]], Momentum[mv[opts][3]]])/2,
	Pair[Momentum[mv[opts][1], ___],
	Momentum[mv[opts][3], ___]] -> -MandelstamU/
	2 + (Pair[Momentum[mv[opts][1]], Momentum[mv[opts][1]]] +
	Pair[Momentum[mv[opts][3]], Momentum[mv[opts][3]]])/2};
...
sturules[opts___] /; (MomentaSumLeft /. Flatten[{opts}] /.
				...
				Phi`Objects`Odd :=
	{Pair[
	Momentum[mv[opts][1], ___],
	Momentum[mv[opts][2], ___]] -> -MandelstamS/
	2 + (Pair[Momentum[mv[opts][1]], Momentum[mv[opts][1]]] +
	Pair[Momentum[mv[opts][2]], Momentum[mv[opts][2]]])/2,
	Pair[Momentum[mv[opts][2], ___],
	Momentum[mv[opts][3], ___]] -> -MandelstamT/
...
MandelstamReduce1[amp_, opts___Rule] :=
	...
	Polarization[a__] :> ToExpression/@Polarization[a]] /.
	sturules[opts] /.
...
indicesdotrule1[optss___] :=
	((Pair | ScalarProduct)[a_,
	b_] /; (! FreeQ[a, Momentum] && ! FreeQ[b, Momentum]) :>
	indsuppdot[a, b, lin[optss]]);
indicesdotrule2[optss___] :=
	(DiracGamma[
	a : Momentum[_, ___] | ___*Momentum[_, ___] |
	HoldPattern[Plus[((___*
	Momentum[_,___]) |
	Momentum[_, ___]) ..]], dim___] :>
...
indsuppdot[
			a : Momentum[_, ___] | ___*Momentum[_, ___] |
					HoldPattern[
						Plus[((___*Momentum[_, ___]) |
						Momentum[_, ___])..]],
						fcdiga1[lorentzdummy, dim___], i_] :=
	a*DiracGamma[loritemp[i, dim], dim] /.
		Momentum[c_, dimm___] -> Pair[Momentum[c, dimm], loritemp[i, dimm]];
...
FourPoint[q_, a_Plus, opts___] :=
	(FourPoint[q, #, opts] & /@ a);
FourPoint[q_, a_*b_, opts___] /; FreeQ[a, q | PropagatorDenominator] :=
	a*FourPoint[q, b, opts];


FourPoint[q_, aa_*FeynAmpDenominator[f___, PropagatorDenominator[Momentum[q1_, d___] + Momentum[q2_,
					d___] + m___, m1_], l___], opts___] :=
	FourPoint[q, aa*MomentumCombine[FeynAmpDenominator[f, PropagatorDenominator[Momentum[q1, d] +
		Momentum[q2, d] + m, m1], l]], opts];

FourPoint[q_,
				FeynAmpDenominator[PropagatorDenominator[Momentum[q1_, d___], m1_], PropagatorDenominator[Momentum[q2_, d___], m2_],
						PropagatorDenominator[Momentum[q3_, d___], m3_], PropagatorDenominator[Momentum[q4_, d___], m4_]]*
					...
					Pair[LorentzIndex[l4_, d___], Momentum[qq4_, d___]],
				opts___] /; (!FreeQ[qq1, q] && ! FreeQ[qq2, q] &&
				!FreeQ[qq3, q] && ! FreeQ[qq4, q]) && (Head[qq1] == Plus ||
						Head[qq2] == Plus || Head[qq3] == Plus || Head[qq4] == Plus) :=
	FourPoint[q,
		Expand[FeynAmpDenominator[PropagatorDenominator[Momentum[q1, d], m1], PropagatorDenominator[Momentum[q2, d], m2],
					PropagatorDenominator[Momentum[q3, d], m3], PropagatorDenominator[Momentum[q4, d], m4]]*
...
FourPoint[q_,
			FeynAmpDenominator[PropagatorDenominator[Momentum[q_, d___], m0_], PropagatorDenominator[Momentum[q_ + _, d___], m1_],
					PropagatorDenominator[Momentum[q_ + _, d___], m2_],
					PropagatorDenominator[Momentum[q_ + _, d___], m3_]]*
				Pair[LorentzIndex[l1_, d___], Momentum[q_, d___]]*Pair[LorentzIndex[l2_, d___],
					Momentum[q_, d___]]*Pair[LorentzIndex[l3_, d___],  Momentum[q_, d___]]*
	...
	I*Pi^2*((Pair[LorentzIndex[l1], LorentzIndex[l2]]*Pair[LorentzIndex[l3], LorentzIndex[l4]] +
				...
				Sum[(Pair[LorentzIndex[l1], LorentzIndex[l2]]*Pair[Momentum[pp[i]], LorentzIndex[l3]]*
								...
								Pair[LorentzIndex[l1], LorentzIndex[l3]]*Pair[Momentum[pp[i]], LorentzIndex[l2]]*
									Pair[Momentum[pp[j]], LorentzIndex[l4]] +
						...
						PaVe[0, 0, i,
							j, {Pair[Momentum[p1, d], Momentum[p1, d]],
								Pair[Momentum[p1 + p2, d], Momentum[p1 + p2, d]],
								Pair[Momentum[p2 + p3, d], Momentum[p2 + p3, d]],
								Pair[Momentum[p3, d], Momentum[p3, d]],
								Pair[Momentum[p2, d], Momentum[p2, d]],
				...
				Sum[(Pair[Momentum[pp[i]], LorentzIndex[l1]]*Pair[Momentum[pp[j]], LorentzIndex[l3]]*
						...
						PaVe[i, j, k,
							l, {Pair[Momentum[p1, d], Momentum[p1, d]],
								Pair[Momentum[p1 + p2, d], Momentum[p1 + p2, d]],
								Pair[Momentum[p2 + p3, d], Momentum[p2 + p3, d]],
								Pair[Momentum[p3, d], Momentum[p3, d]],
								Pair[Momentum[p2, d], Momentum[p2, d]],
...
FourPoint[q_, aa : HoldPattern[Times[___, (_[
	PropagatorDenominator[
	Momentum[_, d___], _] ..]), a___,
	b:((Pair[
		_[_, d___], Momentum[q_,
											d___]]|Pair[
		Momentum[q_,
...
FourPoint[q_, aa : HoldPattern[Times[___, (_[
	PropagatorDenominator[
	Momentum[_, ___], _] ..]), a___]], opts___] /;
	FreeQ[{a},q] :=
	OneLoop[q, Times[aa], opts];

FourPoint[q_, aa : HoldPattern[_[
	PropagatorDenominator[
	Momentum[_, ___], _] ..]], opts___] :=
	OneLoop[q, Times[aa], opts];
...
gaso[DiracGamma[LorentzIndex[mu_, r1___], rr1___], DiracGamma[LorentzIndex[nu_, r2___], rr2___],
			opts___] :=
	(orderfkt = (OrderingFunction /. Flatten[{opts}] /.
	Options[GammaSort]);
	If[ orderfkt[{DiracGamma[LorentzIndex[mu, r1], rr1], DiracGamma[LorentzIndex[nu, r2], rr2]}],
		...
		tl[DiracGamma[LorentzIndex[nu, r2], rr2], DiracGamma[LorentzIndex[mu, r1], rr1]] -
			2*Pair[LorentzIndex[mu, r1], LorentzIndex[nu, r2]]
	]);
par[x_, i_] :=
...
GammaSort[DOT[exp_, ex__],
			opts___] :=
	(exp1 =
	If[ (Gamma5AntiCommute /. Flatten[{opts}] /. Options[GammaSort]) &&
	!FreeQ[tl[exp, ex], DiracGamma[LorentzIndex[5, ___], ___]],
		pos = Position[
				tl[exp, ex], _?(!FreeQ[#, DiracGamma[LorentzIndex[5, ___], __]] &), {1}];
		(-1)^pos*
		Delete[DOT @@ Join[{tl[exp, ex][[pos]]}, {exp}], pos + 1],
		tl[exp, ex]
	];
	exp2 = exp1 /. {tl[aa___, a_, b__, c_,
							cc___] /; (!FreeQ[a, DiracGamma[LorentzIndex[5, ___], __] | gsort] &&
							!FreeQ[c, DiracGamma[LorentzIndex[5, ___], __] | gsort] &&
								FreeQ[{b}, DiracGamma[LorentzIndex[5, ___], __] | gsort]) ->
					tl[aa, a, gsort[b], c, cc],
				tl[aa___, c_,
							cc___] /; (! FreeQ[c, DiracGamma[LorentzIndex[5, ___], __] | gsort] &&
								FreeQ[{aa}, DiracGamma[LorentzIndex[5, ___], __] | gsort]) ->
					tl[gsort[aa], c, cc],
				tl[aa___, c_,
							cc___] /; (! FreeQ[c, DiracGamma[LorentzIndex[5, ___], __] | gsort] &&
...
FCToTracer[exp_,
			opts___] :=
	(res1 =
	exp /. DiracTrace[DOT[a__], ___] :>
		trtr[tin[opts],
			DOT[a] /. {DOT[LorentzIndex[mu_, ___], LorentzIndex[nu_, ___]] ->
							trdot[{LorentzIndex[mu]}, {LorentzIndex[nu]}], fcsig -> trsig,
						DiracGamma[LorentzIndex[mu_, ___], ___] -> {LorentzIndex[mu]},
						Plus[aa___, b_, c___] /; FreeQ[b, DiracGamma] ->
							Plus[aa, trid*b, c],
						Eps[aa__] -> (treps[aa] /.
									LorentzIndex[mu_] -> {LorentzIndex[mu]})} /.
				DOT -> Sequence] /.
	DiracGamma[p_, ___] /; (! FreeQ[p, Momentum]) :> (p /.
			Momentum[pp_, ___] -> pp));
TracerToFC[
			exp_] :=
	...
	res2 /. {Momentum[p_] -> Momentum[p, curdim], {LorentzIndex[mu_]} -> LorentzIndex[mu],
			trdot -> Pair, trsig :> fcsig,
...
DiscardOrders[am_, opts___] :=
	...
	(spf = (Phi`Objects`ScalarProductForm /.
	...
	Cancel[ExpandAll[
					ditchmom[]^2*am /.
										If[ (DiscardMomenta /. Flatten[{opts}] /.
											...
											Momentum[a__] /; FreeQ[{a}, Polarization] ->
											ditchmom[]*Momentum[a, temprec]},
											{}
										] /. (Rule[
													at : # /; FreeQ[at, temprec],
													ditchmom[]*
														at] & /@ $ExpansionQuantities) //. {Pair[
											ditchmom[]*a_, b_] -> ditchmom[]*Pair[a, b],
...
CharacteristicCoefficient[a_, opts___Rule][i_] /;
			Phi`Objects`Private`gaugedimcheck[
					CharacteristicCoefficient, opts, a] === i :=
	(-1)^(Phi`Objects`Private`gaugedimcheck[
...
CayleyHamilton[m__, opts___Rule] :=
	CayleyHamilton[m, opts] =
		Block[ {n = Phi`Objects`Private`gaugedimcheck[
...
licount = (Count[# /. UTrace1 -> tr /. Power -> NMPower /.
					NM -> nm //.
					{nm[a___, l_?((!FreeQ[#, LorentzIndex[__]] && FreeQ[#, _nm]) &),
							ll_?((!FreeQ[#, LorentzIndex[__]] && FreeQ[#, _nm]) &), b___] :>
					nm[a, pp[Unique[pp]], b] /;
							Cases[l, LorentzIndex[__], Infinity] === Cases[ll, LorentzIndex[__], Infinity],
					nm[l_?((!FreeQ[#, LorentzIndex[__]] && FreeQ[#, _nm]) &), a__,
							ll_?((!FreeQ[#, LorentzIndex[__]] && FreeQ[#, _nm]) &)] :>
					nm[a, pp[Unique[pp]]] /;
							Cases[l, LorentzIndex[__], Infinity] ===
							Cases[ll, LorentzIndex[__], Infinity]}, _pp, Infinity] &);
...
CayleyHamiltonRules[mats_List, opts___Rule] :=
	...
	calhamrules, subres*)},
		...
		calham = (subres = (UTrace[
									NM[CayleyHamilton[
				If[ j===1,
					FCPrint[2, "Calling CayleyHamilton on ", submats,
											" (first time only)"]
				];
				Sequence @@ submats,
											Sequence @@
	...
	NMExpand // Expand // CycleUTraces) /.
		(FCPrint[3, "Substituting matrices"];
			(Rule @@ #) & /@
...
CayleyHamiltonTrick[exp_, opts___Rule] :=
	Block[ {ruls},
		ruls =
		CayleyHamiltonRules[FCPrint[1, "Building Cayley-Hamilton rules..."];
...
UIdTrick[expr_,opts___Rule] :=
	expr /. NM -> nm /. idRules /. nm -> NM /.
	UTrace1[] :> (Phi`Objects`Private`gaugedimcheck[UReduce,opts,expr]);

(* At least with the exponential representation these traces are 0. Follows also
	from det u =1. *)

traceRules0 = {UTrace1[
					NM[SMM[x_], Adjoint[FieldDerivative[SMM[x_], _, LorentzIndex[_]]]]] -> 0,
		UTrace1[
					NM[Adjoint[SMM[x_]], FieldDerivative[SMM[x_], _, LorentzIndex[_]]]] -> 0,
		UTrace1[
					NM[Adjoint[FieldDerivative[SMM[x_], _, LorentzIndex[_]]], SMM[x_]]] -> 0,
		UTrace1[
					NM[FieldDerivative[SMM[x_], _, LorentzIndex[_]], Adjoint[SMM[x_]]]] -> 0,
		UTrace1[
					NM[SMM[x_],
						Adjoint[CovariantFieldDerivative[SMM[x_], _, LorentzIndex[_]]]]] -> 0,
			UTrace1[
					NM[Adjoint[SMM[x_]],
						CovariantFieldDerivative[SMM[x_], _, LorentzIndex[_]]]] -> 0,
			UTrace1[NM[
						Adjoint[CovariantFieldDerivative[SMM[x_], _, LorentzIndex[_]]],
						SMM[x_]]] -> 0,
			UTrace1[NM[CovariantFieldDerivative[SMM[x_], _, LorentzIndex[_]],
						Adjoint[SMM[x_]]]] -> 0,
			UTrace1[NM[
						FieldDerivative[FieldDerivative[SMM[x_], x_, LorentzIndex[li2_]],
							x_, LorentzIndex[li1_]], Adjoint[SMM[x_]]]] -> -UTrace1[
						NM[FieldDerivative[SMM[x], x, LorentzIndex[li1]],
							Adjoint[FieldDerivative[SMM[x], x, LorentzIndex[li2]]]]],
			UTrace1[NM[SMM[x_],
						Adjoint[FieldDerivative[
								FieldDerivative[SMM[x_], x_, LorentzIndex[li2_]], x_,
								LorentzIndex[li1_]]]]] -> -UTrace1[
						NM[FieldDerivative[SMM[x], x, LorentzIndex[li2]],
...
uDagRul =
		NM[SMM[x_], Adjoint[FieldDerivative[
			FieldDerivative[SMM[x_], x_, LorentzIndex[li2_]], x_, LorentzIndex[li1_]]]] :>
		-(NM[FieldDerivative[SMM[x], x, LorentzIndex[li2]],
							Adjoint[FieldDerivative[SMM[x], x, LorentzIndex[li1]]]] +
						NM[FieldDerivative[
								FieldDerivative[SMM[x], x, LorentzIndex[li2]], x,
								LorentzIndex[li1]], Adjoint[SMM[x]]] +
						NM[FieldDerivative[SMM[x], x, LorentzIndex[li1]],
							Adjoint[FieldDerivative[SMM[x], x, LorentzIndex[li2]]]])(*/;
...
du[li1_][x_] = FieldDerivative[SMM[x], x, LorentzIndex[li1]];
dua[li1_][x_] = Adjoint[FieldDerivative[SMM[x], x, LorentzIndex[li1]]];


ddu[li1_][x_] = CovariantFieldDerivative[SMM[x], x, LorentzIndex[li1]];
ddua[li1_][x_] =
...
UOrder = (# /. NM -> nm /. (uRules1 /. Condition -> cc /. cc[a_, _] -> a) /. nm -> NM) &;
...
UOrder1 = (# /. NM -> nm /. (uRules2 /. Condition -> cc /. cc[a_, _] -> a) /. nm -> NM) &;

applyuRules12 = (# /. NM -> nm /. uRules1 /. uRules2 /. nm -> NM) &;
applyuRules12n = (# /. NM -> nm /. (uRules1 /. Condition -> cc /. cc[a_, _] -> a) /.
										(uRules2 /. Condition -> cc /. cc[a_, _] -> a) /. nm -> NM) &;

applyuRules21 = (# /. NM -> nm /. uRules2 /. uRules1 /. nm -> NM) &;
applyuRules21n = (# /. NM -> nm /. (uRules2 /. Condition -> cc /. cc[a_, _] -> a) /.
										(uRules1 /. Condition -> cc /. cc[a_, _] -> a) /. nm -> NM) &;
...
UPair[exp_, opts___Rule] :=
	(exp /. (a : HoldPattern[NM[__]]) :> (tmpa = a // applyuRules1;
										If[ Count[a /. usurules, usu, Infinity] >
												Count[tmpa /. usurules, usu, Infinity],
											a,
											tmpa
										]) /. (a : HoldPattern[NM[__]]) :> (tmpa =
				a // applyuRules2;
																			If[ Count[a /. usurules, usu, Infinity] >
																					Count[tmpa /. usurules, usu, Infinity],
																				a,
...
SUNURules[2] :=
	If[ (Explicit/.Options[MM])===False && (Explicit/.Options[SMM])===False,
		{UTrace1[
				NM[Adjoint[CovariantFieldDerivative[MM[x_], x_, LorentzIndex[mu1_]]],
			...
			1/2*UTrace[
					NM[Adjoint[
						...
						CovariantFieldDerivative[MM[x], x, LorentzIndex[mu1]]]]UTrace[
					NM[Adjoint[
...
diffURules = {NM[FieldDerivative[SMM[x_], x_, LorentzIndex[li1_]], SMM[x_]] ->
			FieldDerivative[MM[x], x, LorentzIndex[li1]] -
				NM[SMM[x], FieldDerivative[SMM[x], x, LorentzIndex[li1]]],
		NM[Adjoint[FieldDerivative[SMM[x_], x_, LorentzIndex[li1_]]],
				Adjoint[SMM[x_]]] ->
			Adjoint[FieldDerivative[MM[x], x, LorentzIndex[li1]]] -
				NM[Adjoint[SMM[x]],
					Adjoint[FieldDerivative[SMM[x], x, LorentzIndex[li1]]]]};
									...
									nm@@Table[
											seq[idd[
												...
												adj[CovariantFieldDerivative[MM[pat[x,_]],pat[x,_],
														LorentzIndex[mu[i+1]]]]],{i,1,n,2}]]]/.seq->Sequence);
...
surfaceRules[n_] :=
	...
	surdum + idd[-nm[fdr[nm[f,r],x,LorentzIndex[li1]],dd]]/;
	(FreeQ[dd, ufis, Heads->True] =!=True)&&
	(sr0 || Length[{f,r}]>0&&((m1 = Max[Depth/@
			Union[Cases[{f,r},_FCPartialD|
	_FieldDerivative,Infinity,Heads->True]]])<
	(m2 = Max[Depth/@
				Union[Cases[{dd},_FCPartialD|
	_FieldDerivative,Infinity,Heads->True]]])+n || m1==-Infinity&&m2==-Infinity&&n<=1)),

	surdum + nm[uo___,NM[f___,FieldDerivative[dd_,x_,LorentzIndex[li1_]],r___],
	ou___] :> surdum + idd[nm[
	nm[uo,ou,-nm[NM[fdr[NM[f],x,LorentzIndex[li1]],dd,r]]-
						nm[NM[f,dd,fdr[NM[r],x,LorentzIndex[li1]]]]]-
	nm[fdr[nm[uo,ou],x,LorentzIndex[li1]],NM[f,dd,r]]]]/;
	(FreeQ[dd, ufis, Heads->True] =!=True)&& (sr0 || (m1 = Max[Depth/@
			Union[Cases[{f,r,ou},_FCPartialD|
	...
	surdum + idd[-nm[uo,ou,utr[
				NM[fdr[NM[f],x,LorentzIndex[li1]],dd,r]+
				NM[f,dd,fdr[NM[r],x,LorentzIndex[li1]]]]]-
	nm[fdr[nm[uo,ou],x,LorentzIndex[li1]],
				utr[NM[f,dd,r]]]]/;
	( (FreeQ[dd, ufis, Heads->True] =!=True))&& (sr0 || (m1 = Max[Depth/@
			Union[Cases[{f,r,ou},_FCPartialD|
	_FieldDerivative,Infinity,
	...
	surdum + nm[uo___,NM[f___,Adjoint[FieldDerivative[dd_,x_,LorentzIndex[li1_]]],r___],
	ou___] :>
	surdum + idd[nm[
	nm[uo,ou,-NM[fdr[NM[f],x,LorentzIndex[li1]],Adjoint[dd],r]-
						NM[f,Adjoint[dd],fdr[NM[r],x,LorentzIndex[li1]]]]-
	nm[fdr[nm[uo,ou],x,LorentzIndex[li1]],NM[f,Adjoint[dd],r]]]]/;
	(FreeQ[dd, ufis, Heads->True] =!=True)&& (sr0 || (m1 = Max[Depth/@
			Union[Cases[{f,r,ou},_FCPartialD|
	_FieldDerivative,Infinity,
					Heads->True]]])<
	...
	nm[uo___,utr[NM[f___,Adjoint[FieldDerivative[dd_,x_,
			...
			r___]],ou___]:>
	surdum + idd[-nm[uo,ou,
	utr[NM[fdr[NM[f],x,LorentzIndex[li1]],Adjoint[dd],r]
				+NM[f,Adjoint[dd],fdr[NM[r],x,LorentzIndex[li1]]]]]-
	nm[fdr[nm[uo,ou],x,LorentzIndex[li1]],
...
surfaceRules1[n_] :=
	{
	surdum + nm[f___,dd:(QuantumField[FCPartialD[li1_,___],
	_, ___][x_] | (IsoVector | UVector | UMatrix)[
	QuantumField[FCPartialD[li1_,___], __]][x_] |
	IsoDot[IsoVector[QuantumField[FCPartialD[li1_,___], __]][x_],
	IsoVector[UMatrix[UGenerator[___], ___], ___]]),r___] :>
	surdum + idd[-nm[fdr[nm[f,r],x,LorentzIndex[li1]],dd/.FCPartialD[__]->Sequence[]]]/;
	(FreeQ[dd, ufis, Heads->True] =!=True)&&
	(sr0 || Length[{f,r}]>0&&((m1 = Max[Depth/@
			Union[Cases[{f,r},_FCPartialD|
	_FieldDerivative,Infinity,Heads->True]]])<
	...
	surdum + nm[uo___,NM[f___,dd:(QuantumField[FCPartialD[li1_,___],
	_, ___][x_] | (IsoVector | UVector | UMatrix)[
	QuantumField[FCPartialD[li1_,___], __]][x_] |
	IsoDot[IsoVector[QuantumField[FCPartialD[li1_,___], __]][x_],
	IsoVector[UMatrix[UGenerator[___], ___], ___]]),r___],
	ou___] :> surdum + idd[nm[
	nm[uo,ou,-nm[NM[fdr[NM[f],x,LorentzIndex[li1]],dd/.FCPartialD[__]->Sequence[],r]]-
						nm[NM[f,dd,fdr[NM[r],x,LorentzIndex[li1]]]]]-
	nm[fdr[nm[uo,ou],x,LorentzIndex[li1]],NM[f,dd/.FCPartialD[__]->Sequence[],r]]]]/;
	(FreeQ[dd, ufis, Heads->True] =!=True)&& (sr0 || (m1 = Max[Depth/@
			Union[Cases[{f,r,ou},_FCPartialD|
	_FieldDerivative,Infinity,
					Heads->True]]])<
	...
	surdum + nm[uo___,
	utr[NM[f___,dd:(QuantumField[FCPartialD[li1_,___],
	_, ___][x_] | (IsoVector | UVector | UMatrix)[
	QuantumField[FCPartialD[li1_,___], __]][x_] |
	IsoDot[IsoVector[QuantumField[FCPartialD[li1_,___], __]][x_],
	IsoVector[UMatrix[UGenerator[___], ___], ___]]),
			r___]],ou___]:>
	surdum + idd[-nm[uo,ou,utr[
				NM[fdr[NM[f],x,LorentzIndex[li1]],dd/.FCPartialD[__]->Sequence[],r]+
				NM[f,dd/.FCPartialD[__]->Sequence[],fdr[NM[r],x,LorentzIndex[li1]]]]]-
	nm[fdr[nm[uo,ou],x,LorentzIndex[li1]],
				utr[NM[f,dd/.FCPartialD[__]->Sequence[],r]]]]/;
	(FreeQ[dd, ufis, Heads->True] =!=True)&& (sr0 || (m1 = Max[Depth/@
			Union[Cases[{f,r,ou},_FCPartialD|
	_FieldDerivative,Infinity,
					Heads->True]]])<
	...
	surdum + nm[uo___,NM[f___,Adjoint[dd:(QuantumField[FCPartialD[li1_,___],
	_, ___][x_] | (IsoVector | UVector | UMatrix)[
	QuantumField[FCPartialD[li1_,___], __]][x_] |
	IsoDot[IsoVector[QuantumField[FCPartialD[li1_,___], __]][x_],
	IsoVector[UMatrix[UGenerator[___], ___], ___]])],r___],
	ou___] :>
	surdum + idd[nm[
	nm[uo,ou,-NM[fdr[NM[f],x,LorentzIndex[li1]],Adjoint[dd/.FCPartialD[__]->Sequence[]],r]-
						NM[f,Adjoint[dd/.FCPartialD[__]->Sequence[]],fdr[NM[r],x,LorentzIndex[li1]]]]-
	nm[fdr[nm[uo,ou],x,LorentzIndex[li1]],NM[f,Adjoint[dd/.FCPartialD[__]->Sequence[]],r]]]]/;
	(FreeQ[dd, ufis, Heads->True] =!=True)&& (sr0 || (m1 = Max[Depth/@
			Union[Cases[{f,r,ou},_FCPartialD|
	_FieldDerivative,Infinity,
					Heads->True]]])<
	...
	surdum +
	nm[uo___,utr[NM[f___,Adjoint[dd:(QuantumField[FCPartialD[li1_,___],
	_, ___][x_] | (IsoVector | UVector | UMatrix)[
	QuantumField[FCPartialD[li1_,___], __]][x_] |
	IsoDot[IsoVector[QuantumField[FCPartialD[li1_,___], __]][x_],
	IsoVector[UMatrix[UGenerator[___], ___], ___]])],
			r___]],ou___]:>
	surdum + idd[-nm[uo,ou,
	utr[NM[fdr[NM[f],x,LorentzIndex[li1]],Adjoint[dd/.FCPartialD[__]->Sequence[]],r]
				+NM[f,Adjoint[dd/.FCPartialD[__]->Sequence[]],fdr[NM[r],x,LorentzIndex[li1]]]]]-
	nm[fdr[nm[uo,ou],x,LorentzIndex[li1]],
	utr[NM[f,Adjoint[dd/.FCPartialD[__]->Sequence[]],r]]]]/;
	(FreeQ[dd, ufis, Heads->True] =!=True)&& (sr0 || (m1 = Max[Depth/@
			Union[Cases[{f,r,ou},_FCPartialD|
	_FieldDerivative,Infinity,
					Heads->True]]])<=
...
SurfaceReduce[expr_,opts___Rule] :=
	...
	{QuantumField[pd:(FCPartialD[_]..), r__?(FreeQ[#, {FCPartialD}, Heads -> True] &)][x_] :>
	FieldDerivative[qf[r][x], x, (LorentzIndex @@ #) & /@ {pd}],
	IsoDot[IsoVector[
				QuantumField[pd : (FCPartialD[_] ..), r__?(FreeQ[#, {FCPartialD}, Heads -> True] &)]][x_],
		l_] :> FieldDerivative[
			isod[IsoVector[qf[r]][x], l], x, (LorentzIndex @@ #) & /@ {pd}] /;
		FreeQ[l, FCPartialD | FieldDerivative | CovariantFieldDerivative |
				CovariantNabla, Heads -> True]}*);
		res = surdum + Expand[NMExpand[If[ Head[#]===Times,
										nm@@#,
										nm[#]
									]&/@re]] /. UTrace1[a_]^n_ :>
		...
		(surfaceRules1[n]/.sr0->False/.fq->FreeQ/.usq->UnsameQ) //.
				(surfaceRules[n]/.sr0->False/.fq->FreeQ/.usq->UnsameQ) /. idd -> Identity /. nm -> Times /. surdum -> 0/.
					qf -> QuantumField /.isod -> IsoDot /. fdr -> FieldDerivative /.
					utr -> UTrace/. FieldDerivative[_,LorentzIndex[_]]->0 //
						UTraceTrick
	];
													...
													NM[uExpLeftAdj[x, ExpansionOrder -> do],
																	FieldStrengthTensorFull[{li1},
																		UGeneratorMatrixIsoDot[
																			QuantumField[Particle[LeftComponent[0]], {li2}][x]],
																		x, -I], Adjoint[uExpLeftAdj[x, ExpansionOrder -> do]]] +
																NM[Adjoint[uExpRight[x, ExpansionOrder -> do]],
																	FieldStrengthTensorFull[{li1},
																		UGeneratorMatrixIsoDot[
																			QuantumField[Particle[RightComponent[0]], {li2}][x]],
	...
	Block[ {or, lim, quants, ruls, subs, a, b, i, summ, UCoeff},
		...
		lim = Which[NumericQ[or], {i, 0, or},
				Head[or] ===
					...
					Sequence @@ or}, True, Message[UPerturb::"badlim", or];
										Return[]];
		quants = UFields /. {opts} /. Options[UPerturb];
		subs = (#[a__][b__] :> #[a, b]) & /@ quants;
		ruls = ((#[a__] -> ((summ[UCoeff[#][i][a], lim])) & /@ quants) /.
					summ -> Sum);
		exp /. subs /. ruls /. UCoeff -> UCoefficient /.
		pm -> If[ (SUNN /. {opts} /. Options[UPerturb]) === 2,
				Pion,
				PhiMeson
			]
	];
	...
	StringReplace[
				ToString[
					x /. _RenormalizationState -> Sequence[] /.
									...
									(SU2Delta|SU3Delta|SUNDelta)[a_, b_] :>
										"\\delta_{" <> ToString[a] <> ToString[b] <> "}" /.
								Pair[Momentum[p2], Momentum[p2]]^i_ :>
									"q^" <> ToString[2i] //.

						(*Phi`Renormalization` is not in $ContextPath *)
						{Phi`Renormalization`LeutwylerJBar[a__, __Rule] :>
						Phi`Renormalization`LeutwylerJBar[a],
...
FixFermionAdjoints[ex_] :=
	...
	DOT[Adjoint[QuantumField[d, Particle[Fermion[f], r], rr][x]],
	DiracGamma[ExplicitLorentzIndex[0]]], QuantumField[d___,
		Adjoint[DiracBar[Particle[Fermion[f_], r___]]], rr___][x_] :>
	DOT[DiracGamma[ExplicitLorentzIndex[0]],
		QuantumField[d, Particle[Fermion[f], r], rr][x]]} //
	DiracSimplify) /.
	DOT[Adjoint[DiracGamma[LorentzIndex[mu_]]],
		DiracGamma[ExplicitLorentzIndex[0]]] :>
	DOT[DiracGamma[ExplicitLorentzIndex[0]],
		DiracGamma[LorentzIndex[mu]]] // DiracSimplify) /.
	DOT[Adjoint[QuantumField[d___, Particle[Fermion[f_], r___], rr___][x_]],
		DiracGamma[ExplicitLorentzIndex[0]]] :>
	QuantumField[d, DiracBar[Particle[Fermion[f], r]], rr][x] //
	DiracSimplify;
