...
FeynAmpDenominatorSimplify[exp_, OptionsPattern[]] :=
	...
	PropagatorDenominator /. FeynAmpDenominator -> feyncan;

FeynAmpDenominatorSimplify[exp_,Momentum[q1_, ___]] :=
	FeynAmpDenominatorSimplify[exp, q1];

FeynAmpDenominatorSimplify[exp_,Momentum[q1_, ___], Momentum[q2_,___]] :=
...
mtr[a_. FeynAmpDenominator[
			PropagatorDenominator[pe_. + Momentum[q1_,___], 0]
		],
	q1_] :=
	0 /; FreeQ[{a,pe}, q1];

(* if the only scale is OPEDelta^2 *)
mtr[a_. (Power2[any1_. + any2_. Pair[Momentum[q1_,___],Momentum[OPEDelta,___]],
	(vv_/; Head[vv] =!= Integer)]) *
	FeynAmpDenominator[
	...
	q1_] :=
	0 /;
	FreeQ[{a, pe}, q1](* && !FreeQ[w, q1]*);

mtr[a_. ((any1_. + any2_. Pair[Momentum[q1_,___],Momentum[OPEDelta,___]])^(vv_/; Head[vv] =!= Integer))*
	FeynAmpDenominator[
		PropagatorDenominator[pe_. + Momentum[q1_,di___], 0]
	],
	q1_] :=
...
mtr[a_. FeynAmpDenominator[
	...
	FeynCalcInternal -> False]]] /; nufaQ[pe];
...
mmtr[a_.FeynAmpDenominator[
			...
			d:PropagatorDenominator[Momentum[q1_,di___]-Momentum[pe1_,___] + Momentum[pe2_,___], m3_]..
		],
	q1_] :=
...
mmtr[a_.FeynAmpDenominator[
			b:PropagatorDenominator[Momentum[q1_,di___], m1_]..,
			d:PropagatorDenominator[Momentum[q1_,di___]-Momentum[pe1_,___] + Momentum[pe2_,___],m2_]..,
			c:PropagatorDenominator[Momentum[q1_,di___]-Momentum[pe1_,___], m3_]..
		],
	q1_] :=
	FeynAmpDenominatorSimplify[Expand2[EpsEvaluate[ExpandScalarProduct[
...
sumtra[xx_,q1_] :=
	mmtr[
	If[ !FreeQ[xx, PropagatorDenominator[_,m_/;m=!=0]], (* THEN *)
		xy =  mtr[xx,q1] /. mtr -> qid, (* ELSE *)
...
fadallq1q2[y_Times, q1_,q2_] :=
	SelectFree[y,{q1,q2}] *
	fadalll[SelectNotFree[y,{q1,q2}], q1,q2];

fadalll[0,__] :=
	0;
fadalll[exp_Plus, q1_, q2_ ] :=
	Map[fadallq1q2[#, q1,q2]&,exp
		] /. fadallq1q2 -> fadalll;
			...
			*)
						...
						qqq[(fa_.) *
							...
							FeynAmpDenominator[a___]
									...
									PropagatorDenominator[_. Momentum[q1,___] +
										_. Momentum[pe_ /; FreeQ[pe,q2],___],
																_]
												],
						qqq[(fa_.) *
							q1pw[Pair[Momentum[OPEDelta,di___], Momentum[q1, dim___]] +
