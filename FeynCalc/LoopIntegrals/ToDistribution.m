...
1/(a Epsilon)  DeltaFunction[1-x] + 1/(1-x) + a Epsilon Log[1-x]/(1-x) + \
1/2 a^2 Epsilon^2 Log[1-x]^2/(1-x) and (1-x)^(a Epsilon - 2) in exp by \
-DeltaFunctionPrime[1-x]/Epsilon + (1/(1-x)^2 + (a Epsilon ) Log[1-x]/(1-x)^2 + \
