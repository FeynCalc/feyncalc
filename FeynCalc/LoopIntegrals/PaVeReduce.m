...
f[1][{pp_, m02_,m12_}] :=
	demon[ pp - m12 + m02 ];
f[1][{p10_,p12_,p20_, m02_,m12_,m22_}] :=
	demon[ p10 - m12 + m02 ];
f[2][{p10_,p12_,p20_, m02_,m12_,m22_}] :=
	demon[ p20 - m22 + m02 ];
...
c[1][{pp_, m12_, m22_}] :=
	{m12};
c[0][{p10_,p12_,p20_, m02_,m12_,m22_}] :=
	{p12, m22, m12};
c[1][{p10_,p12_,p20_, m02_,m12_,m22_}] :=
	{p20, m02, m22};
c[2][{p10_,p12_,p20_, m02_,m12_,m22_}] :=
	{p10, m02, m12};
...
PaVeReduce[x_, y___Rule] :=
	Block[ {op, wriout, nnx = x},
...
pavereduce[brex_,optis___] :=
	Block[ {sq,t,tt,ma,rest,lin,
