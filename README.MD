...
and download the most recent *Release_X_X_X_X.zip* file (currently it is [Release_8_2_0_0.zip](https://github.com/FeynCalc/feyncalc/archive/Release-8_2_0_0.zip) ). Copy the
