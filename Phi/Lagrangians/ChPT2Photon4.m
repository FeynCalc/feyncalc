...
ChPT2Photon4::"usage"=
"ChPT2Photon4.m is the name of the file containing the definitions for
ULagrangian[ChPT2Photon[4]], which is the pionic ChPT lagrangian to
fourth order in the energy, first written down by
Gasser and Leutwyler.  To evaluate use ULagrangian";

L1::"usage"=
"L1 := UCouplingConstant[ChPT2Photon[4],1] is one of the constants of the
fourth order ChPT lagrangian";

L2::"usage"=
"L2 := UCouplingConstant[ChPT2Photon[4],2] is one of the constants of the
fourth order ChPT lagrangian";

L3::"usage"=
"L3 := UCouplingConstant[ChPT2Photon[4],3] is one of the constants of the
fourth order ChPT lagrangian";

L4::"usage"=
"L4 := UCouplingConstant[ChPT2Photon[4],4] is one of the constants of the
fourth order ChPT lagrangian";

L5::"usage"=
"L5 := UCouplingConstant[ChPT2Photon[4],5] is one of the constants of the
fourth order ChPT lagrangian";

L6::"usage"=
"L6 := UCouplingConstant[ChPT2Photon[4],6] is one of the constants of the
fourth order ChPT lagrangian";

L7::"usage"=
"L7 := UCouplingConstant[ChPT2Photon[4],7] is one of the constants of the
fourth order ChPT lagrangian";

L8::"usage"=
"L8 := UCouplingConstant[ChPT2Photon[4],8] is one of the constants of the
fourth order ChPT lagrangian";

L9::"usage"=
"L9 := UCouplingConstant[ChPT2Photon[4],9] is one of the constants of the
fourth order ChPT lagrangian";

L10::"usage"=
"L10 := UCouplingConstant[ChPT2Photon[4],10] is one of the constants of the
fourth order ChPT lagrangian";

H1::"usage"=
"H1 := UCouplingConstant[ChPT2Photon[4],11] is one of the constants of the
fourth order ChPT lagrangian";

H2::"usage"=
"H2 := UCouplingConstant[ChPT2Photon[4],12] is one of the constants of the
fourth order ChPT lagrangian";
...
L1 := UCouplingConstant[ChPT2Photon[4],1];
L2 := UCouplingConstant[ChPT2Photon[4],2];
L3 := UCouplingConstant[ChPT2Photon[4],3];
L4 := UCouplingConstant[ChPT2Photon[4],4];
L5 := UCouplingConstant[ChPT2Photon[4],5];
L6 := UCouplingConstant[ChPT2Photon[4],6];
L7 := UCouplingConstant[ChPT2Photon[4],7];
L8 := UCouplingConstant[ChPT2Photon[4],8];
L9 := UCouplingConstant[ChPT2Photon[4],9];
L10:= UCouplingConstant[ChPT2Photon[4],10];
H1 := UCouplingConstant[ChPT2Photon[4],11];
H2 := UCouplingConstant[ChPT2Photon[4],12];
...
UCouplingConstant/:
  MakeBoxes[
    UCouplingConstant[ChPT2Photon[4],11,st___RenormalizationState,
...
UCouplingConstant/:
  MakeBoxes[
    UCouplingConstant[ChPT2Photon[4],12,st___RenormalizationState,
      sc___RenormalizationScheme,qs___QuarkMassExpansionState],
    TraditionalForm]:=
  SubsuperscriptBox[MakeBoxes[StyleForm["H",FontSlant->"Italic"]][[1]],
...
UCouplingConstant/:
  MakeBoxes[
    UCouplingConstant[ChPT2Photon[4],i_,st___RenormalizationState,
      sc___RenormalizationScheme,qs___QuarkMassExpansionState],
    TraditionalForm]:=
...
RenormalizationCoefficients[ChPT2Photon[4]]:=
...
$ULagrangians=Union[$ULagrangians,{ChPT2Photon[4]}];
