...
Begin["`Private`"];
   SetAttributes[Twist2CounterOperator, ReadProtected];
...
uc3[p1_, p3_, mu_, a_,cou_] := Block[
 {dp1, dp2, dp3, i=OPEi, m=OPEm},
...
uc5[ p_, mu_, nu_, a_, b_, cou_] := Block[
...
(I*Global`ALIEN*CA*Gstrong^3*Sn*(1+Power2[-1,OPEm])*
(FV[OPEDelta,mu1]*FV[OPEDelta,mu2]*FV[p1,mu3]*
...
End[]; EndPackage[];
(* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ *)
If[$VeryVerbose > 0,WriteString["stdout", "Twist2CounterOperator | \n "]];
Null
